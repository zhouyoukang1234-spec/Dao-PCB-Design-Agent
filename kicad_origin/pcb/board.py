...
class Board:
    ...
    @classmethod
    def empty(cls, *, version: int = 20240108, generator: str = "kicad_origin") -> "Board":
        """Create a minimal empty board."""
        tree = [
            Symbol("kicad_pcb"),
            ...
            [Symbol("layers"),
                ...
                [31, "B.Cu", Symbol("signal")],
                [36, "B.SilkS", Symbol("user"), "B.Silkscreen"],
                [37, "F.SilkS", Symbol("user"), "F.Silkscreen"],
                [44, "Edge.Cuts", Symbol("user")],
            ],
            [Symbol("net"), 0, ""],
        ]
        return cls(tree)
