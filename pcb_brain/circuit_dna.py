...
_stm32g031_nets = {
    ...
    # STM32G031 无独立 BOOT0 脚: BOOT0 与 PA14/SWCLK 复用同一物理脚(脚21, nBOOT_SEL 出厂置位),
    # 故 R2 的下拉实际落在 PA14/SWCLK 网上(10k 下拉不妨碍 SWD), 归并为同一真实网络(原模板按 F103
    # 习惯把 BOOT0 当独立脚→该端点永远落不到物理焊盘=虚高预测)。R2.1→GND 使 BOOT0=0 即 Flash 启动。
    "SWCLK_BOOT0": [("U1","PA14_SWCLK"),("J1","3"),("R2","2")],
...
_stm32h743_nets = {
    ...
    "GND":       [("U1","GND"),("C5","2"),("C6","2"),("C7","2"),("C8","2"),("C9","2"),("C10","2"),
                  ("C11","2"),("Y1","GND"),("Y2","GND"),("SW1","2"),("FB1","1"),("FB2","1"),("R2","2")],
    "NRST":      [("U1","NRST"),("C11","1"),("SW1","1"),("R1","2"),("J1","5")],
    # BOOT0 经 R2 下拉到 GND (正常 Flash 启动); 原模板把 R2.1 同时挂 3V3 与 BOOT0 (物理短路)
    "BOOT0":     [("U1","BOOT0"),("R2","1")],
    # 4 脚晶振端子为 1/3 脚 (2/4 为外壳地, 已并入 GND); 原模板 OSC_OUT/RTC_OUT 误写 2 脚 (与地短路)
    "OSC_IN":    [("U1","PH0"),("Y1","1"),("C1","1")],
    "OSC_OUT":   [("U1","PH1"),("Y1","3"),("C2","1")],
    "RTC_IN":    [("U1","PC14"),("Y2","1"),("C3","1")],
    "RTC_OUT":   [("U1","PC15"),("Y2","3"),("C4","1")],
    # SWD 与 JTAG 共用同一组物理脚 (ARM: PA13=SWDIO=JTMS, PA14=SWCLK=JTCK, PB3=SWO=JTDO),
    # 故 J1(SWD)/J2(JTAG) 对应脚本就是同一网络; 原模板分成 SWDIO/TMS 等独立网=同脚双网(去修正产物)
    "SWDIO_TMS": [("U1","PA13"),("J1","2"),("J2","7")],
    "SWCLK_TCK": [("U1","PA14"),("J1","3"),("J2","9")],
    "SWO_TDO":   [("U1","PB3"), ("J1","4"),("J2","13")],
    "TDI":       [("U1","PA15"),("J2","5")],
    "TRST":      [("U1","PB4"), ("J2","3")],
    "3V3":       [("R1","1"),("J1","1"),("J2","1")],
}
...
_motor_driver_nets = {
    "VM":      [("J3","1"),("C1","1"),("C2","1"),("U1","VM1"),("U1","VM2"),("U1","VM3")],
    "VCC":     [("J4","1"),("C3","1"),("C4","1"),("U1","VCC")],
    "GND":     [("J3","2"),("J4","2"),("C1","2"),("C2","2"),("C3","2"),("C4","2"),("U1","PGND1"),("U1","PGND2"),("U1","GND"),("J5","8")],
    "AO1":     [("U1","AO1"),("J1","1")],
    "AO2":     [("U1","AO2"),("J1","2")],
    "BO1":     [("U1","BO1"),("J2","1")],
    "BO2":     [("U1","BO2"),("J2","2")],
...
_safety_protection_nets = {
    # 修正: TVS/二极管为 2 端器件, 原网表给其虚构了不存在的 "GND" 脚, 且把分流 TVS 的
    # 阳极误接到输入轨。依本模板 design_notes ("SMBJ: 正极接GND, 负极接12V/5V轨"; MBRS340
    # 为 12V→5V 串联肖特基) 归正: 分流 TVS 阴极 K→被保护轨、阳极 A→GND; 串联肖特基无 GND。
    "12V_IN":    [("F1","1")],
    "12V":       [("F1","2"),("D1","K"),("D4","A")],
    "5V_IN":     [("F2","1")],
    "5V":        [("F2","2"),("D2","K"),("D4","K")],
...
_ch32v003_components = [
    ...
    Comp("J2", "GPIO_A",        "Connector_PinHeader_2.54mm","PinHeader_1x08_P2.54mm_Vertical",         (58.0, 45.0), "interface", "GPIO扩展(PA1/PA2/PD0/PD2/PD3/PD4/PC0/PC1)"),
...
_ch32v003_nets = {
    ...
    # 修正: CH32V003 端口A仅有 PA1/PA2 (无 PA3-PA7, 原模板误按 STM32 风格)。依 WCH
    # 数据手册: 单线调试 SWIO=PD1、复位 NRST 复用 PD7; J2 扩展头其余脚改用真实可用
    # GPIO (PD0/PD2/PD3/PD4)。
    "SWIO":    [("U1","PD1"),("J1","2")],
    "NRST":    [("U1","PD7"),("R1","2"),("SW1","1")],
    "NRST_PU": [("R1","1")],
    "PA1":     [("U1","PA1"),("J2","1")],
    "PA2":     [("U1","PA2"),("J2","2")],
    "PD0":     [("U1","PD0"),("J2","3")],
...
_aerial_nets = {
    ...
    # 修正: TVS1(SMAJ28A)为 2 焊盘 D_SMA, 原网表引用了不存在的第3脚且把阳极接到 VBAT_FUSED;
    # 归正为分流 TVS: 阴极(1)→VBAT、阳极(2)→GND。J2(USB-C)原引用虚构数字脚 2-6, 改用真实
    # USB Type-C 焊盘标号(A6=D+/A7=D-/A5=CC1/B5=CC2/A1=GND, 依 USB-C 规范)。
    "GND":       [("J1","2"),  ("C1","2"),  ("C2","2"),  ("TVS1","2"),("U1","1"),  ("D1","2"),  ("C3","2"),  ("C4","2"),  ("C5","2"),  ("C6","2"),  ("U2","3"),  ("C7","2"),  ("C8","2"),  ("C9","2"),  ("C10","2"), ("U3","2"),  ("U3","5"),  ("R1","2"),  ("C11","2"), ("U4","2"),  ("C12","2"), ("C13","2"), ("C14","2"), ("C15","2"), ("C16","2"), ("C17","2"), ("SW1","2"),  ("U5","2"),  ("C18","2"), ("U6","2"),  ("C19","2"), ("C20","2"), ("C21","2"), ("U7","2"),  ("C22","2"), ("C23","2"), ("U8","2"),  ("C24","2"), ("C25","2"), ("R6","2"),  ("R7","2"),  ("D2","2"),  ("D3","2"),  ("J3","3"),  ("J4","3"),  ("J5","3"),  ("J6","3"),  ("J2","A1"),  ("C26","2"), ("R13","2"), ("C27","2"), ("J12","4")],
    # ── MCU时钟 ───────────────────────────────────────────────
...
# 注: U1 引脚改用真实 LQFP-48 功能脚名 (经 GD32F103C8T6≡STM32F103C8Tx 符号解析到物理焊盘),
# 取代原模板的虚构顺序编号 (1..20, 曾致 VCC/SWDCLK 同抢 9 脚、GND/UART0_TX 同抢 10 脚的物理
# 短路)。晶振 Y1 端子为 1/3 脚 (2/4 为外壳地), 原写 1/2 同属虚构编号, 一并归正。
_gd32_nets = {
    # VCC/GND 直接收纳各接口的电源/地脚 (取代原模板用伪元件 ("VCC"/"GND",n) 桥接网络的写法,
    # 那些伪 ref 非真实元件、永远落不到物理焊盘, 是虚高的预测端点; 此处归并到真实电源/地网)
    "VCC":      [("U1","VBAT"),("U1","VDD"),("C3","1"),("C4","1"),("C5","1"),("R1","1"),("J4","1"),("J1","3"),("J2","3")],
    "VDDA":     [("U1","VDDA"),("C6","1")],
    "GND":      [("U1","VSS"),("U1","VSSA"),("C1","2"),("C2","2"),("C3","2"),("C4","2"),("C5","2"),("C6","2"),("C7","2"),("R2","1"),("J4","2"),("Y1","2"),("Y1","4"),("SW1","2"),("J1","4"),("J2","4"),("D1","2")],
    "OSC_IN":   [("U1","PD0"),("Y1","1"),("C1","1")],
    "OSC_OUT":  [("U1","PD1"),("Y1","3"),("C2","1")],
    "NRST":     [("U1","NRST"),("R1","2"),("SW1","1"),("C7","1")],
    "BOOT0":    [("U1","BOOT0"),("R2","2")],
    "SWDIO":    [("U1","PA13"),("J1","1")],
    "SWDCLK":   [("U1","PA14"),("J1","2")],
    "UART0_TX": [("U1","PA9"),("J2","1")],
    "UART0_RX": [("U1","PA10"),("J2","2")],
    "PA0":      [("U1","PA0"),("J3","1")],
    "PA1":      [("U1","PA1"),("J3","2")],
    "PA2":      [("U1","PA2"),("J3","3")],
    "PA3":      [("U1","PA3"),("J3","4")],
